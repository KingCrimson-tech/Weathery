...
async function searchWeather() {
    try {
        ...
        const response = await fetch(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${city}?unitGroup=metric&key=${API_KEY}&include=current,days,hours`);
...
async function getCurrentLocation() {
    ...
    try {
        ...
        const response = await fetch(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${latitude},${longitude}?unitGroup=metric&key=${API_KEY}&include=current,days,hours`);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    weatherInfo.innerHTML = `
        <div style="text-align: center; padding: 40px; color: #666;">
            <i class="fas fa-cloud-sun" style="font-size: 3rem; color: #1a73e8; margin-bottom: 20px;"></i>
